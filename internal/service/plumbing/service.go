...
type PlumpingRepository interface {
	...
	SearchItem(ctx context.Context, languageCode string, isProducer, isPainted, isGarant, isAqua *bool, searchQuery string, minPrice, maxPrice *float64) ([]*models.ItemResponse, error)
	//Item
