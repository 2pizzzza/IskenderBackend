...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/getCollectionWithoutDiscount": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.ItemWithoutDiscount"
                            }
                        }
                    },
                    "500": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.RemoveReview"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request body or review not found",
                        "schema": {
                            "$ref": "#/definitions/models.ErrorMessage"
                        }
                    },
        ...
        "/api/switchIsShowReview": {
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Successfully switch review",
                        "schema": {
                            "$ref": "#/definitions/models.Message"
                        }
                    },
